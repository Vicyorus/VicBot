...
class command(object):
    ...
    #You found the easter egg! This function is a tribute to Johann Carl Friedrich Gauss, a great mathematician
    #Gauss progression function. Sums up all the numbers from 'x' to 'y' with a difference of 'z'
